...
export function UsersSection() {
  return (
    <ScreenshotSection
      id="users"
      eyebrow="USERS"
      headline="Designed around your users."
      ...
      caption="Pixel & Ping · Users"
      flip="right"
      features={[
        { title: 'A focused list, not a database', desc: 'Search and filter surface the right person in seconds — no scroll fatigue.' },
