...
export function HeroCanvas() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      atmo.addColorStop(0, 'rgba(46, 125, 255, 0.10)');
      atmo.addColorStop(0.4, 'rgba(70, 183, 255, 0.04)');
      ...
      halo.addColorStop(0, 'rgba(70, 183, 255, 0.25)');
      halo.addColorStop(0.3, 'rgba(46, 125, 255, 0.12)');
      halo.addColorStop(1, 'rgba(46, 125, 255, 0)');
      ctx!.fillStyle = halo;
      ctx!.beginPath();
      ...
      for (let i = 0; i < 3; i++) {
        ...
        ctx!.rotate(rot);
        ctx!.strokeStyle = `rgba(70, 183, 255, ${0.32 - i * 0.08})`;
        ctx!.lineWidth = 0.8;
      ...
      core.addColorStop(0.2, 'rgba(139, 243, 230, 0.6)');
      core.addColorStop(0.5, 'rgba(70, 183, 255, 0.35)');
      core.addColorStop(1, 'rgba(46, 125, 255, 0)');
      ctx!.fillStyle = core;
      ctx!.beginPath();
      ...
      vig.addColorStop(1, 'rgba(7, 8, 10, 0.7)');
      ctx!.fillStyle = vig;
      ctx!.fillRect(0, 0, w, h);
